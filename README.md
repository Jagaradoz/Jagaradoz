...
- 🧭 **Taskflow SaaS** - Full‑stack project management SaaS with RBAC, orgs, and team collaboration.
- 🧾 **Text‑to‑SQL** - One‑box app that turns natural language into SQL and returns results.
- ✈️ **Flight Booking Chatbot** - Tool‑calling LLM assistant that handles the flight booking flow end‑to‑end.
- 🎙️ **Speech Summarizer CLI** - Local‑first CLI: transcribe audio and emit structured JSON summaries.
...
[![Instagram](https://img.shields.io/badge/Instagram-E4405F?style=flat-square&logo=instagram&logoColor=white)](https://www.instagram.com/jagaradoz)
